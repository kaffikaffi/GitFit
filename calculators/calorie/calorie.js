...
// Function that calculates the calorie intake and writes it in html, gives a different amount of calories depending on the inputs. 
function calculateCalories(){
    ...
    //checks if all the values in the inputfield are correct and return true
