...
let nav_obj = {//array can only contain words without spaces
  "main-page":"Home",
  fitness:"Fitness",
...
function renderHeader(ul,obj) {
  for(i in obj) {
    ...
    a.textContent = obj[i];
    if(i == "main-page") {
      a.setAttribute("href", checkUrl("../")+ i + "/index.html");
    } else {
      a.setAttribute("href", checkUrl("../")+ i + "/"+ i + ".html");
    }
    li.appendChild(a);
    ul.appendChild(li);
  }
...
renderHeader(UL_ELEMENT,nav_obj)
